...
public class Hint {
	...
	Hint(String criminalHint1, String criminalHint2, String motivationHint1, String motivationHint2, String toolHint1, String toolHint2){//게임 시작 시 기본 힌트 세팅
	...
	static void cardCount(int criminalCountNum, int motivationCountNum, int toolCountNum) {//2번째판 이상부터 선택적 힌트 설정 메서드
		Card cd = new Card();
	...
	void hintPrintln(int hintcount) {//선택적 힌트 출력 메서드
		Card cd = new Card();
		if(hintcount==1) {
	...
	int userHint(int hintcount) {//힌트 제공받은 후 사용자 추리 시작을 알리는 메서드
		User users = new User();
