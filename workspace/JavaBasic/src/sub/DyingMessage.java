...
public class DyingMessage{
	...
	void showCardList() {//카드 목록을 보이게 하는 함수
		Card cd = new Card();
	...
	static String userMenu() {//힌트별 메뉴 세팅
		String userSetMenu;
		if(hintcount==1 || hintcount==2 || hintcount==3|| hintcount==4 ) {
	...
	void userMenuSettings() {//사용자 선택 메뉴에 따른 작업 호출
